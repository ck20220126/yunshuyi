            ...
            <footer className="bg-[#f7f8fa] mr-[232px] pt-[50px] pb-[40px] px-[10%] text-[#1D2129] text-[12px]">
                ...
                <div className="flex flex-wrap">
                  <div className="min-w-[150px]">
                    ...
                    <ul className="mt-[15px] leading-[26px]">
                      <li><Link href="#">平台介绍</Link></li>
                      <li><Link href="#">平台数据</Link></li>
                      <li><Link href="#">联系我们</Link></li>
                      <li><Link href="#">投诉反馈</Link></li>
                    </ul>
                  </div>
                  <div className="min-w-[150px]">
                    <h4 className="leaing-[24px] text-[16px] font-[500]">新闻与媒体</h4>
                    <ul className="mt-[15px] leading-[26px]">
                      <li><Link href="#">公司新闻</Link></li>
                      <li><Link href="#">行业政策</Link></li>
                      <li><Link href="#">行业新闻</Link></li>
                      <li><Link href="#">媒体聚焦</Link></li>
                    </ul>
                  </div>
                  <div className="min-w-[150px]">
                    <h4 className="leaing-[24px] text-[16px] font-[500]">平台手册</h4>
                    <ul className="mt-[15px] leading-[26px]">
                      <li><Link href="#">注册流程</Link></li>
                      <li><Link href="#">注册流程</Link></li>
                      <li><Link href="#">注册流程</Link></li>
                    </ul>
                  </div>
                  <div className="min-w-[150px]">
                    ...
                    <ul className="mt-[15px] leading-[26px]">
                      <li><Link href="#">云南天成</Link></li>
                      <li><Link href="#">小黄牛</Link></li>
                      <li><Link href="#">知百道</Link></li>
                      <li><Link href="#">峡谷之星</Link></li>
                    </ul>
                  </div>
                </div>
                <div className="w-[1px] h-[146px] bg-[#EBECF0] mx-[70px]" />
              ...
              <div className="mt-[40px] leading-[26px]">
                ...
                <p className="flex items-center">
                  ...
                  <span className="ml-[20px] inline-flex items-center"><Image src={"/footer-gongan.png"} width={16} height={16} alt="" className="inline-block mr-[5px]" />滇公网安备 53019002000175号</span>
                  <span className="ml-[20px] inline-flex items-center"><Image src={"/footer-wangjian.png"} width={16} height={16} alt="" className="inline-block mr-[5px]" />工商网监</span>
                </p>
              </div>
            </footer>
          </div>
