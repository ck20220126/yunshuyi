      ...
      <div className="relative max-w-[1920px] min-h-full mx-auto pt-[10%] pb-[13%]">
        <div className="relative">
          ...
          >
            ...
            <div className="border border-white px-[30px] pt-[80px] pb-[50px]">
              <h2 className="font-bold leading-[76px] text-[66px] text-center">02</h2>
              <ul className="mt-[75px]">
                <li className="menu-item">
                  <Link href={'#'} className="menu-item__link">
                    云品优选
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-[45vh] z-10 flex flex-col justify-center items-center leading-[20px] text-[14px] cursor-pointer" onClick={onClickMenu}>
          <i className="icon">
