...
export default function ProcureProduct(props: { 
  id: string
  title: string
  price: string
  address: string
  ...
  return (
    <Link href={`/pq-sale/procure/${props.id}`}>
      <motion.div 
        className="border border-[#EBECF0]" 
        animate={{ borderColor: hover ? '#1D5FFF' : '#EBECF0', borderWidth: hover ? 2 : 1 }}
