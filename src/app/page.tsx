  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pr-sider-padding">
        <div className="flex justify-end desktop:justify-center relative">
          <Image src={'/one-bg-2.webp'} alt="" fill className="absolute w-full h-full object-cover" />
          <div className="w-full max-w-[1090px] mx-[auto] py-[100px]">
            <div className="relative z-10 flex">
              <div className="flex-shrink-0 w-[39.5%] flex gap-x-[30px]">
              ...
              <div className="ml-[13.77%] mt-[100px]">
        ...
        <ColumnSwiper />
        <div className="flex justify-end desktop:justify-center">
          <NewSwiper className="w-full max-w-[1388px] py-[150px]" />
        </div>
        ...
        <div className="bg-[#F7F8FA] flex justify-end desktop:justify-center">
          <div className="max-w-[1388px] py-[150px] flex justify-between">
        ...
        <div className="flex justify-end desktop:justify-center">
          <div className="w-full max-w-[1388px] py-[150px] flex justify-between">
            <div className="flex-1 mr-[10.8%] pt-[20px]">
