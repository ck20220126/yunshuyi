...
export default function FinancialService() {
  return (
    <div className="pr-[232px]">
      <DetailCover image="/logistics-header.png" title="供应链 仓储物流服务" subtitle="利用互联网、物联网、大数据、人工智能、云计算、区块链、5G等关键技术实现整个物流体系无人化、数字化、智能化" />
