    ...
    <div className="pr-[232px]">
      <div className="mx-[11.75%] mt-[30px] pb-[150px]">
        ...
        <div className="mt-[30px] grid grid-cols-5 gap-x-[22px] gap-y-[30px]">
          ...
          <ProcureProduct id="06" image="/procure-product-1.webp" title="食用植物调和油 5L装 多种规格支持贴牌代工 批发代发" price="64.9" address="昆明高新区总仓发货" />
          <ProcureProduct id="07" image="/procure-product-1.webp" title="食用植物调和油 5L装 多种规格支持贴牌代工 批发代发" price="64.9" address="昆明高新区总仓发货" />
          <ProcureProduct id="08" image="/procure-product-1.webp" title="食用植物调和油 5L装 多种规格支持贴牌代工 批发代发" price="64.9" address="昆明高新区总仓发货" />
          <ProcureProduct id="09" image="/procure-product-1.webp" title="食用植物调和油 5L装 多种规格支持贴牌代工 批发代发" price="64.9" address="昆明高新区总仓发货" />
          <ProcureProduct id="10" image="/procure-product-1.webp" title="食用植物调和油 5L装 多种规格支持贴牌代工 批发代发" price="64.9" address="昆明高新区总仓发货" />
          <ProcureProduct id="11" image="/procure-product-1.webp" title="食用植物调和油 5L装 多种规格支持贴牌代工 批发代发" price="64.9" address="昆明高新区总仓发货" />
          <ProcureProduct id="12" image="/procure-product-1.webp" title="食用植物调和油 5L装 多种规格支持贴牌代工 批发代发" price="64.9" address="昆明高新区总仓发货" />
        </div>
      </div>
    </div>
  )
